...
am__DIST_COMMON = $(srcdir)/Makefile.in COPYING INSTALL TODO compile \
...
CXXFLAGS = -g -O2
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"chat\" -DPACKAGE_TARNAME=\"chat\" -DPACKAGE_VERSION=\"0.31\" -DPACKAGE_STRING=\"chat\ 0.31\" -DPACKAGE_BUGREPORT=\"blu.eagle@mail.ru\" -DPACKAGE_URL=\"\" -DPACKAGE=\"chat\" -DVERSION=\"0.31\" -DHAVE_STDIO_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_STRINGS_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_UNISTD_H=1 -DSTDC_HEADERS=1 -DHAVE_ARPA_INET_H=1 -DHAVE_SYS_SOCKET_H=1 -DHAVE_UNISTD_H=1 -DHAVE__BOOL=1 -DHAVE_SOCKET=1
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
